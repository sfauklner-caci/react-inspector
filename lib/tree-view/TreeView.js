...
var reducer = function reducer(state, action) {
  switch (action.type) {
    case 'TOGGLE_EXPAND':
      var _path = action.path;
      var expandedPaths = state.expandedPaths;
      var expanded = !!expandedPaths[_path];

      return Object.assign({}, state, {
        expandedPaths: Object.assign({}, state.expandedPaths, (0, _defineProperty3.default)({}, _path, !expanded))
      });
    default:
      return state;
  }
...
var ConnectedTreeNode = function (_Component) {
  ...
  (0, _createClass3.default)(ConnectedTreeNode, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      var previouslyExpandedPaths = prevState.previouslyExpandedPaths;

      var previouslyExpanded = !!previouslyExpandedPaths[path];
      ...
      if (expanded !== previouslyExpanded) {
        if (this.props.handleExpand) this.props.handleExpand();
      }
    }
  }, {
    key: 'handleClick',
