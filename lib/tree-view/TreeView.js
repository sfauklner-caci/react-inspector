...
var ConnectedTreeNode = function (_Component) {
  ...
  function ConnectedTreeNode() {
    ...
    return (0, _possibleConstructorReturn3.default)(this, (ConnectedTreeNode.__proto__ || Object.getPrototypeOf(ConnectedTreeNode)).apply(this, arguments));
  }

  (0, _createClass3.default)(ConnectedTreeNode, [{
    key: 'shouldComponentUpdate',
    value: function shouldComponentUpdate(nextProps) {
      return !!nextProps.expandedPaths[nextProps.path] !== !!this.props.expandedPaths[this.props.path] || nextProps.data !== this.props.data || nextProps.name !== this.props.name;
    }
...
var TreeView = function (_Component2) {
  ...
  (0, _createClass3.default)(TreeView, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      this.setState({
        expandedPaths: (0, _pathUtils.getExpandedPaths)(nextProps.data, nextProps.dataIterator, nextProps.expandPaths, nextProps.expandLevel, this.state.expandedPaths)
      });
    }
  }, {
    key: 'render',
